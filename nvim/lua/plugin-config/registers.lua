return function()
	...
	registers.setup({
		...
		events = {
			-- When a register line is highlighted, show a preview in the main
			-- buffer with how the register will be applied, but only if the register will be inserted or pasted
